...
const AboutHome = () => {
  ...
  return (
    <div className="flex justify-between items-center">
        ...
        <h1 className={`text-2xl text-emerald-800 font-serif font-bold leading-relaxed capitalize mb-4 ${mode === "dark" ? 'text-white' : "text-emerald-800"}`}>Want to know more about to<br /> our services and our company</h1>
