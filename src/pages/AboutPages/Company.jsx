...
const Company = () => {
  ...
  return (
    <div className="w-[100%] h-auto p-5 overflow-hidden ">
      ...
      <div className="grid grid-cols-2 p-5 gap-3 mt-2 w-auto h-auto mx-auto ">
         <div className="p-8 mr-2 overflow-hidden">
             ...
             <p className={`text-lg mt-4  text-justify font-medium font-sans ${mode === 'light' ? "text-black" : 'text-gray-500'} max-w-2xl`}>Carod Seller is the type of service providing company. We provide services of selling the luxourious cars.We do agreement  with luxourious car brand to sell the car at home.We saves your time. You can buy all luxourious car brand at home at one click.We also need emloyee to work in company if you want to do job book appointment and submit resume to sheduelde your interview. We provide suitable environment to work. We provide cafet area, playground, silent room for work. </p>
             <div className="flex justify-between items-center gap-16 mt-6">
                <button type="submit" className="border-2 border-red-700 w-[180px] p-2 font-bold font-serif text-2xl bg-red-700 text-white rounded-lg hover:bg-black hover:text-white cursor-pointer hover:border-black transition-all">Know More</button>
                <button type="submit" className="border-2 border-orange-700 w-[180px] p-2 font-bold font-serif text-2xl bg-orange-700 text-white rounded-lg hover:bg-black hover:text-white cursor-pointer hover:border-black transition-all">Get Job</button>
             </div>
        </div>
